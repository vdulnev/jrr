...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,fileKey,name,artist,album,albumArtist,albumArtistAuto,genre,duration,trackNumber,discNumber,totalDiscs,imageUrl,bitrate,bitDepth,sampleRate,channels,totalTracks,filePath,dateReadable]);
...
switch (_that) {
case _Track() when $default != null:
return $default(_that.fileKey,_that.name,_that.artist,_that.album,_that.albumArtist,_that.albumArtistAuto,_that.genre,_that.duration,_that.trackNumber,_that.discNumber,_that.totalDiscs,_that.imageUrl,_that.bitrate,_that.bitDepth,_that.sampleRate,_that.channels,_that.totalTracks,_that.filePath,_that.dateReadable);case _:
  return orElse();
