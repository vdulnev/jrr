...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,fileKey,name,artist,album,albumArtist,albumArtistAuto,genre,duration,playbackRange,trackNumber,discNumber,totalDiscs,imageUrl,bitrate,bitDepth,sampleRate,channels,totalTracks,filePath,dateReadable]);
